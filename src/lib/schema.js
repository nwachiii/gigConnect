...
export const userProfileSchema = Yup.object().shape({
	...
	experience: Yup.array().of(experienceValidation).required('At least one experience is required'),
	...
	bio: Yup.string().min(100, 'The overview cannot be less than 100 characters').required('This field is required'),
