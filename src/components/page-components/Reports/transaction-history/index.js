import {Box, Button, Divider, Flex, HStack, Image, Stack, Text, useDisclosure} from '@chakra-ui/react';
...
export const TransactionHistory = () => {
	...
	return (
		<Stack maxW='1120px' w='full' padding='16px 44px' alignItems='center' justifyContent='space-between' spacing='20px' mx='auto'>
			...
			<Stack bg='#FFF' border='1px solid #EDEEEF' p={4} w='full' rounded='12px' divider={<Divider />}>
				<Stack borderRadius='12px' border='1px solid #EDEEEF' w='full' p={4} gap={2} bg='#053AF9' color='#FFFFFF' align='center' justify='center' h='115px'>
				...
				<Stack minH={'315px'} align={'center'} gap='12px' pt={8}>
					<HStack w='full' align='end' justify='space-between' gap='16px'>
						...
						<Stack align='start'>
							...
							<Flex border='1px solid #EDEEEF' align='center' justify='space-between' rounded='8px' p={'12px'} gap='8px' h='44px' w='190px'>
								<Text fontSize={14} color='#878C95'>
									All transactions
								</Text>
						...
						<Stack align='start'>
							...
							<Flex border='1px solid #EDEEEF' align='center' justify='space-between' rounded='8px' p={'12px'} gap='8px' h='44px' w='135px'>
								<Text fontSize={14} color='#878C95'>
									All talents
								</Text>
								<Image src='/img/icons/dropdownArrow.svg' boxSize='24px' />
						...
						<Button fontWeight={400} p='8px 16px' color='#FFF' border='1px solid #EDEEEF' bg='#202329' rounded='12px' w='145px' h='40px'>
							Download CSV
						</Button>
						<Button
							fontWeight={400}
					...
					<Stack minH='460px' align='center' justify='center' w='full' gap='18px'>
						...
						<Text textAlign={'center'} maxW={'330px'} lineHeight='24px' fontWeight={600}>
							No transactions
						</Text>
