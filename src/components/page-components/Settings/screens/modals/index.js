	...
	return (
		<Modal isOpen={isOpen} onClose={onClose}>
			...
			<ModalContent rounded='16px' w='full' maxW={step === 1 ? 650 : 980}>
				<ModalHeader display={'flex'} paddingInline={0} p={2} justifyContent={'end'} borderBottom={'1px solid #EDEEEF'}>
					<Stack bg={'#F6F7F7'} border='1px solid #EDEEEF' justify={'center'} p={2} rounded={'full'} w='max-content' justifySelf={'end'}>
						<ModalCloseButton top={0} right={0} boxSize={'max-content'} position='relative' justifySelf='end' />
					</Stack>
				</ModalHeader>
				<ModalBody w='full'>
					<Stack w='full'>
