	...
	return (
		<VStack gap={4} align={'start'} pb={4}>
			...
			<HStack gap={4} w='full' align='self-start'>
				<Stack maxW={'452px'}>
					<Heading lineHeight={'48px'}>Continue with Google Authenticator</Heading>
					<Text maxW={300} fontSize={14} color={'#4C5361'}>
						Scan this code generated using the google authenticator app for your registered email address.
					</Text>
				</Stack>
				<Stack align={'start'} border={'1px solid #edeeef'} rounded={'12px'} p={6} bg='#FFFF'>
