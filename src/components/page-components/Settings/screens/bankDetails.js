			...
			<Stack w='full' p={2}>
				<Stack borderRadius='12px' border='1px solid #EDEEEF' w='full' p={2} pl={4} justify='start' align='start'>
					<Text color='#4C5361' fontSize={14}>
						Ensure your bank account details match your account information accurately.
					</Text>
				</Stack>
				<Stack>
					<Stack w='full' justify='space-between' p={2} gap={4}>
						<Stack gap={2}>
							...
							<Select rounded={'8px'} fontSize={14} color='#707581' placeholder='Select Bank'>
						...
						<Text fontSize={14} color='#707581'>
							Generated bank details here...
						</Text>
					</Stack>
					<HStack w='full' justify='end' mt={8}>
						<Button fontWeight={400} color='#4C5361' h='40px' p='8px 16px' gap={2} rounded={'12px'} bg='#F6F7F7' border='1px solid #EDEEEF' onClick={handleEdit} w='160px'>
							Discard
						</Button>
						<Button fontWeight={400} color='#FFFFFF' h='40px' p='8px 16px' gap={2} rounded={'12px'} bg='#053AF9' boxShadow='sm' w='160px' onClick={saveEdit}>
							Add Bank Details
						</Button>
					</HStack>
				</Stack>
