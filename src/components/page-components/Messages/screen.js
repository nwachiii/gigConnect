...
export const MessageScreen = ({person, hideUserInfo}) => {
	...
	return (
		<Stack gap={4} p={6} flex={1}>
			...
			<Stack justify={'end'} h={'100%'} rounded={'16px'} border={'1px solid #EDEEEF'} p={4}>
				<Button alignSelf={'end'} w={'176px'} bg='#202329' gap={2} p='6px' rounded='12px' _hover={{bg: ''}} mb={4}>
					...
					<Text fontSize={14} color='#fff' fontWeight={400}>
						Schedule a Meeting
					</Text>
				</Button>
				<Stack align={'start'} pb={4}>
					<Box bg={'#F6F7F7'} color={'#344054'} p={3} borderRadius={'3px 15px 15px 15px'} border={'1px solid #EDEEEF'}>
				...
				{messages.map((msg, index) => (
					<Stack align={'end'} key={index} pb={4}>
						<Box bg={'#053AF9'} color={'#FFF'} p={3} borderRadius={'15px 3px 15px 15px'}>
