...
export const ProfileRateStep = ({handleProgress}) => {
	...
	return (
		<VStack gap={4} align={'start'} w={'full'} px={6} mb={4}>
			...
			<HStack gap={2} mb={4}>
				<Button bg={'#F6F7F7'} color={'#4C5361'} rounded={'12px'} fontWeight={400} px={4} py={'6px'} fontSize={14} onClick={handleProgress} h={'max-content'} border={'1px solid #EDEEEF'}>
					Skip for now
				</Button>
				<Button bg={'#053AF9'} color={'white'} rounded={'12px'} fontWeight={400} px={4} py={'6px'} fontSize={14} onClick={handleProgress} isDisabled={formik.errors.bio} h={'max-content'}>
