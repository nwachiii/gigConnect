	...
	const displayPaymentScreen = (key) => {
		switch (key) {
			case 'withdrawalScreen':
				return <WithdrawalScreen formattedValue={formattedValue} setFormattedValue={setFormattedValue} handleScreen={setScreen} withdrawModal={withdrawModal} />;
			case 'otpScreen':
				return <WithdrawOTP formattedValue={formattedValue} handleScreen={setScreen} handleClose={handleClose} />;
			case 'withdrawSuccess':
				return <WithdrawSuccess withdrawModal={withdrawModal} />;
			default:
				return <WithdrawalScreen formattedValue={formattedValue} setFormattedValue={setFormattedValue} handleScreen={setScreen} withdrawModal={withdrawModal} handleClose={handleClose} />;
		}
	};
