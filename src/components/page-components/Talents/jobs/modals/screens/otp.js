import {Button, Flex, HStack, Heading, Image, ModalContent, Text, VStack} from '@chakra-ui/react';
	...
	return (
		<ModalContent
			...
			<VStack
				...
				<Text color={'#4C5361'} textAlign={'center'} lineHeight={'18px'} fontSize={14} px={20}>
					A six (6) digit code has been sent to your email address ***mkl@gmail.com and your phone number ***490 to confirm fund transfer
				</Text>
				<Flex
					//   maxW="165px"
					h='48px'
					...
					<Image src='/img/icons/editIcon.svg' boxSize={'16px'} cursor={'pointer'} onClick={() => handleScreen('withdrawScreen')} />
				</Flex>
				<OTPInput
					sx={{
						bg: '#fff',
