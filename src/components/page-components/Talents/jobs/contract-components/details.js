      ...
      <Stack w="full">
        ...
        >
          ...
          <Text fontSize={12} maxW={350}>
            Nam fermentum leo quis luctus lobortis. Proin a ultricies leo, a
            auctor mi. Praesent scelerisque volutpat dui, in egestas tellus
            porttitor et. Etiam convallis turpis et quam maximus luctus. Etiam
            molestie ante eu nibh efficitur faucibus. Nunc vel dolor in tellus
            eleifend rutrum. Nulla facilisi. Etiam euismod facilisis purus at
            ullamcorper. Maecenas vel egestas nulla, nec aliquam tellus.
            Praesent dictum mi nec lorem porta lobortis. Pellentesque habitant
            morbi
          </Text>
          ...
          <Stack w="full">
            ...
            <Stack divider={<StackDivider />}>
              ...
              <Flex fontSize={12} gap={6} px={4} py={1}>
                ...
                <Text maxW={250}>
                  Nam fermentum leo quis luctus lobortis. Proin a ultricies leo,
                  a auctor mi. Praesent scelerisque volutpat dui, in egestas
                  tellus porttitor et. Etiam convallis turpis et quam maximus
                  luctus tiam molestie ante eu nibh efficitur faucibus Nunc vel
                  dolor in tellus eleifend rutrum. Nulla facilisi.
                </Text>
              </Flex>
              <Button
                fontWeight={400}
          ...
          <Stack w="full">
            ...
            <Stack border="1px solid #F6F7F7">
              ...
              <Text px={2} maxW={200} fontSize={12}>
                Etiam euismod facilisis purus at ullamcorper. Maecenas vel
                egestas nulla, nec aliquam tellus.
              </Text>
            </Stack>
          </Stack>
          <Button
