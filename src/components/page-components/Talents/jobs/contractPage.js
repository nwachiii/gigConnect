          ...
          >
            ...
            >
              ...
              <Text>
                <span style={{ color: "#053AF9", fontWeight: 500 }}>
                  GigConnect Payment Protection.
                </span>{" "}
                Only pay for the work you authorize.
              </Text>
              <HStack align={"end"}>
                <Text fontWeight={700}>
                  Payed a fixed price for this project
                </Text>
              ...
              <Text color={"#707581"}>
                This is the price you and James Daniels have agreed upon
              </Text>
              <Stack>
                <HStack align={"end"}>
                  <Text fontWeight={700}>
                    Deposit funds into Escrow Balance
                  </Text>
                  <Image src="/img/icons/questionBox.svg" />
                </HStack>
                <Text>
            ...
            <HStack w={"full"} justify={"end"} gap={2} my={4}>
              <Button
                ...
                color={"#fff"}
                border={"1px solid #EDEEEF"}
                onClick={offerDeclinedModal.onOpen}
              >
                Decline Offer
              </Button>
              <Button
