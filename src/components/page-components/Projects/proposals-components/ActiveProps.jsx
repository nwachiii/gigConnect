		...
		<Stack>
			...
			<HStack borderRadius='12px' border='1px solid #EDEEEF' w='full' p={4} justify={'space-between'} gap={4}>
				<Stack gap={2}>
					...
					<Text fontSize={14}>Clients may contact you first about a job posting. If you don't want these inquiries, you can set your profile to private.</Text>
				</Stack>
				<Image src='/img/icons/rightArrow.svg' />
			</HStack>
			<HStack borderRadius='12px' border='1px solid #EDEEEF' w='full' p={4} justify={'space-between'} gap={4}>
				<Stack gap={2}>
					...
					<Text fontSize={14}>These are proposals that you are discussing with a client.</Text>
				</Stack>
				<Image src='/img/icons/rightArrow.svg' />
			</HStack>
			<HStack borderRadius='12px' border='1px solid #EDEEEF' w='full' p={4} justify={'space-between'} gap={4}>
				<Stack gap={2}>
					...
					<Text fontSize={14}>These are proposals you sent which have not yet received a reply.</Text>
				</Stack>
				<Image src='/img/icons/rightArrow.svg' />
			</HStack>
		</Stack>
