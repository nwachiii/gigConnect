...
import {Box, Flex, IconButton, Button, HStack, Stack, Collapse, useDisclosure, useColorModeValue, Image, Avatar, Drawer, DrawerBody, DrawerHeader, DrawerContent, DrawerOverlay, Menu, MenuButton, MenuList, MenuItem, Text} from '@chakra-ui/react';
...
export const HeaderWithNav = () => {
	...
	return (
		<Flex borderBottom='1px solid #EFEFEF' background='#FFF' display='flex' maxW='1440px' w='full' padding='13px 44px' alignItems='center' justifyContent='space-between' gap='56px' h='67px' mx="auto">
			<Box>
			...
			<Flex alignItems={'center'} flex={'0.3'} justify={'space-between'} gap='8px'>
				<NotifIcon />
				<UserProfileMenu />
			</Flex>
