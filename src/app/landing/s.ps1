<div className="flex flex-col items-center self-stretch px-20 py-12 mt-24 w-full bg-white border-solid border-t-[1.5px] border-t-[color:var(--Foundation-Grey-Grey--25,#F6F7F7)] max-md:px-5 max-md:mt-10 max-md:max-w-full">
            <div className="flex gap-5 justify-between mt-3 w-full text-base font-semibold leading-5 text-right whitespace-nowrap max-w-[1144px] text-zinc-800 max-md:flex-wrap max-md:max-w-full">
              <Image
                alt=""
                loading="lazy"
                src="https://cdn.builder.io/api/v1/image/assets/TEMP/d177c14e567709c9b688719474322e5f347f4032ed75eafdd4936137502a35ee?apiKey=79769cd1053a464cbdb4afd62642704d&"
              ...
              <div className="flex gap-2.5 self-start">
                ...
                <Image
                  alt=""
                  loading="lazy"
                  src="https://cdn.builder.io/api/v1/image/assets/TEMP/07c3a2d72ba7b9db03ec1e0e7522a5eb97715a2ae221f9bcb8858874ec1d2def?apiKey=79769cd1053a464cbdb4afd62642704d&"
                  className="aspect-square w-[30px]"
                />
                <Image
                  alt=""
                  loading="lazy"
                  src="https://cdn.builder.io/api/v1/image/assets/TEMP/422c469f945fb5ce9c3e143b35f9473275fd83209e363773e6086aa22b135328?apiKey=79769cd1053a464cbdb4afd62642704d&"
                  className="aspect-square w-[30px]"
                />
                <Image
                  alt=""
                  loading="lazy"
                  src="https://cdn.builder.io/api/v1/image/assets/TEMP/cebe6a146f4a9ddff03e05bf15d8f538a9755737f095e83ba5789cd6f8d153eb?apiKey=79769cd1053a464cbdb4afd62642704d&"
                  className="aspect-square w-[30px]"
                />
                <Image
                  alt=""
                  loading="lazy"
                  src="https://cdn.builder.io/api/v1/image/assets/TEMP/3c99f6194dcc380600c26bcf0f7f806c7ee31a474da6dd5b9c5c465a8a68c334?apiKey=79769cd1053a464cbdb4afd62642704d&"
                  className="aspect-square w-[30px]"
                />
                <Image
                  alt=""
                  loading="lazy"
                  src="https://cdn.builder.io/api/v1/image/assets/TEMP/604e781230c0b6a950c590a1c830ae5fd7d14c2a224cf7b4e02631a107d26c53?apiKey=79769cd1053a464cbdb4afd62642704d&"
                  className="aspect-square w-[30px]"
                />
              </div>
            </div>
                ...
                <div className="flex flex-col w-3/5 max-md:ml-0 max-md:w-full">
                  <div className="flex flex-col grow text-sm text-zinc-800 max-md:mt-10 max-md:max-w-full">
                    ...
                    <div className="justify-center px-4 py-2 mt-2.5 leading-6 border border-solid backdrop-blur-xl bg-white bg-opacity-70 border-gray-100 border-opacity-60 rounded-[48px] max-md:max-w-full">
                      <span className="font-bold">Address:</span> No 191B jide
                      Oki street off Ligali Ayorinde lane Victoria
