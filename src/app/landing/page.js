...
const LandingPage = () => {
	return (
		<Box>
			<VStack>
				<HStack justify={'space-between'} maxW={{base: 'full', md: '1144px'}} fontSize={'small'} w={'full'} flexWrap={{base: 'wrap', md: 'unset'}} p={6}>
					<Image alt='' loading='lazy' src='https://cdn.builder.io/api/v1/image/assets/TEMP/0e3e404e12133fa241c13c34e21a6a900abdd5368f8fc120fe4ce068a3efe869?apiKey=79769cd1053a464cbdb4afd62642704d&' maxW={'165px'} />
				...
				<VStack gap={6} mt={10}>
					<Heading fontSize={'xxx-large'} fontWeight={800} w={{base: '350px', md: '500px'}} textAlign={'center'}>
					...
					<HStack gap={3} align={'center'}>
						<Link href='/auth/sign-in'>
							<GCButton px={4} py={6} color={'#fff'} background={theme.bgColor.GC_black}>
								Sign In
							</GCButton>
						</Link>
						<Link href='/auth/create-account'>
							<GCButton background={'#1d4ed8'} color={'#fff'} borderRadius={'xl'} px={4} py={6} className='text-stondiv0'>
								Create an Account
							</GCButton>
						</Link>
					</HStack>
				...
				<HStack border={'1px solid #E4E4E4'} borderRadius={16} px={3} py={2} justify={'space-between'} maxW={{base: '350px', md: '450px'}} mt={{base: 5, md: 0}} w={'full'}>
					<Text my={'auto'}>Search for talents</Text>
					<Image alt='' loading='lazy' src='https://cdn.builder.io/api/v1/image/assets/TEMP/70897acfe1af8117c1c0fba16f148b001f0a00eceed01d81b3a033686f7d87cf?apiKey=79769cd1053a464cbdb4afd62642704d&' maxW={'full'} minW={{base: '50px', md: '150px'}} />
				</HStack>
			</VStack>
			<VStack mt={10}>
				...
				<Flex gap={2} flexWrap={'wrap'} maxW={'750px'} align={'center'} justify={'center'} fontSize={'14px'} textAlign={'center'}>
				...
				<Flex flexWrap={{base: 'wrap', md: 'unset'}} align={'center'} gap={{base: 8, md: 5}} maxW={{base: '300px', md: '710px'}} justify={'center'}>
					<Image alt='' loading='lazy' src='https://cdn.builder.io/api/v1/image/assets/TEMP/8bc86019e375b0e4549420b728cf174e10984a2d236cf1a24a3e094fc523a0cd?apiKey=79769cd1053a464cbdb4afd62642704d&' flex={{base: '1 0 5%', md: 'unset'}} maxW={'75px'} />
					<Image alt='' loading='lazy' src='https://cdn.builder.io/api/v1/image/assets/TEMP/71199560a0989cf53f65cc6d11c6e6d3b4cf1cf7ae44c7e4f7094af255563d0f?apiKey=79769cd1053a464cbdb4afd62642704d&' flex={{base: '1 0 5%', md: 'unset'}} maxW={'75px'} />
					<Image alt='' loading='lazy' src='https://cdn.builder.io/api/v1/image/assets/TEMP/ae0db319b5290940e5f263ba199176dec922bcb0d9b6e62f8fa5d5c5c9f1e394?apiKey=79769cd1053a464cbdb4afd62642704d&' flex={{base: '1 0 5%', md: 'unset'}} maxW={'75px'} />
					<Image alt='' loading='lazy' src='https://cdn.builder.io/api/v1/image/assets/TEMP/5d972321053e3e139e41a8c65e1cfffd8f2579abd8d421e9cb150883dc3d440e?apiKey=79769cd1053a464cbdb4afd62642704d&' flex={{base: '1 0 5%', md: 'unset'}} maxW={'75px'} />
				</Flex>
				<ClientSection />
				<WhyGig />
				<TopTalents />
			...
			<VStack>
				<Box maxW={{base: 'full', md: '1144px'}} background={'#F6F7F7'} mt={{base: 10, md: 28}} pt={12} px={{base: 5, md: 28}} borderRadius={'32px'}>
					<VStack mt={6} maxW={{base: 'full', md: '875px'}} gap={6}>
						<Text bg={'white'} textAlign={'center'} fontWeight={500} lineHeight={5} px={4} py={2} color={'#5599FF'} border={'1.5px solid #EDEEEF'} backdropBlur={'24px'} fontSize={'18px'} borderRadius={'32px'}>
							Be Mobile
						</Text>
						<Heading fontSize={{base: 32, md: 60}} letterSpacing={{md: 'tighter'}} lineHeight={{base: '51px', md: '64px'}} fontWeight={500} textAlign={'center'}>
							Download the Talent app and stay updated on your journey
						</Heading>
						<HStack w={{base: 'full', md: '430px'}} gap={4} flexWrap={{base: 'wrap', md: 'unset'}}>
