...
import {Box, Flex, Heading, VStack, Input, InputGroup, InputRightElement, Text, Image, useToast, Link, Stack} from '@chakra-ui/react';
							...
							<Form>
								<VStack spacing={'28px'}>
									...
									<Field name='password'>
										{({field}) => (
											<VStack align={'start'} w={'full'}>
												...
												<InputGroup>
													<Input {...field} type='password' placeholder='Enter password' isInvalid={errors.password && touched.password} {...sharedInputStyles} />
													<InputRightElement>
									...
									<Stack w='full' spacing='28px'>
										<GCButton type='submit' w={'full'} bg='#0D0D0D' py={'12px'} h='42px' color={'#fff'}>
											Sign in
										</GCButton>
